...
compile-python(){
  ...
  apt update
  apt install -y make build-essential libssl-dev zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev wget curl llvm libncurses5-dev libncursesw5-dev xz-utils tk-dev liblzma-dev tk-dev libffi-dev
...
apt update
apt install -y nginx tesseract-ocr tesseract-ocr-eng janus libevent-dev libgpiod-dev
cd  /tmp
